      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <main className="lg:col-span-3 space-y-8">
            ...
            {/* Controles de Vista */}
            <div className="bg-white p-4 rounded-[2rem] shadow-sm border border-black/[0.03] flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <Select defaultValue="default">
                  <SelectTrigger className="w-40 md:w-48 rounded-xl border-none bg-muted/30 focus:ring-primary/20 h-11 font-bold text-xs uppercase tracking-wider">
                  ...
                  <SelectContent className="rounded-2xl border-none shadow-2xl">
                    ...
                    <SelectItem value="rating" className="font-bold text-[10px] uppercase tracking-widest">Más valorados</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center gap-3 pt-12">
              <Button variant="ghost" className="w-12 h-12 rounded-full font-black bg-white shadow-sm border border-black/5 hover:bg-primary hover:text-white transition-all">
                <ChevronDown className="w-5 h-5 rotate-90" />
              </Button>
              <Button className="w-12 h-12 rounded-full font-black bg-secondary text-primary shadow-xl shadow-secondary/20 hover:scale-110 transition-transform">01</Button>
              <Button variant="ghost" className="w-12 h-12 rounded-full font-black bg-white shadow-sm border border-black/5 hover:bg-primary/5">02</Button>
              <Button variant="ghost" className="w-12 h-12 rounded-full font-black bg-white shadow-sm border border-black/5 hover:bg-primary hover:text-white transition-all">
                <ChevronDown className="w-5 h-5 -rotate-90" />
              </Button>
            </div>

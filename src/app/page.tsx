...
export default async function Home() {
  ...
  return (
    <div className="bg-[#F6F6F6] min-h-screen">
      ...
      <section className="py-24 bg-[#F6F6F6] text-center space-y-12 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 md:px-8 space-y-10">
          ...
          <Carousel className="w-full">
                ...
                <CarouselItem key={i}>
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-muted-foreground uppercase tracking-[0.2em]">Dueña de PetShop "El Refugio"</p>
                    </div>
                  </div>
                </CarouselItem>
              ))}
            ...
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex justify-between px-4 pointer-events-none">
              <CarouselPrevious className="relative translate-y-0 left-0 h-14 w-14 bg-black text-white hover:bg-primary border-none rounded-full shadow-lg pointer-events-auto" />
              <CarouselNext className="relative translate-y-0 right-0 h-14 w-14 bg-black text-white hover:bg-primary border-none rounded-full shadow-lg pointer-events-auto" />
            </div>
          </Carousel>
        </div>
      </section>
          ...
          {[
            ...
            <div key={i} className="flex flex-col gap-6 group cursor-pointer">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold tracking-tight text-foreground group-hover:text-primary transition-colors leading-tight">{post.t}</h3>
      ...
      <footer className="w-full">
        ...
        <div className="bg-[#FEF9F3] py-24 text-center">
          <div className="max-w-3xl mx-auto px-4 space-y-10">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground font-medium text-lg">Recibe listas de precios actualizadas y novedades del mercado.</p>
            </div>
            <div className="relative max-w-lg mx-auto">
              <div className="relative flex items-center bg-white rounded-full h-16 px-2 shadow-sm border border-black/5">
                <input type="email" placeholder="Tu correo electrónico" className="flex-1 h-full bg-transparent outline-none px-8 font-medium text-sm text-foreground" />
                <Button className="rounded-full bg-primary text-white font-black px-10 h-12 shadow-md">
                  Suscribirse
                </Button>
              </div>
            </div>
        ...
        <div className="bg-primary text-white py-20 px-4 md:px-8">
            ...
            <div className="md:col-span-2 space-y-8">
              <Link href="/" className="flex items-center gap-4">
                ...
                <div className="flex flex-col -space-y-1">
                  <span className="font-black text-3xl tracking-tighter uppercase leading-none">MyDog</span>
              ...
              <div className="flex gap-4">
                {[Facebook, Instagram, Twitter].map((Icon, i) => (
                  <Link key={i} href="#" className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-white text-white hover:text-primary transition-all">
            ...
            <div>
              ...
              <ul className="space-y-5 text-sm font-bold text-white/70">
                {['Home', 'Tienda', 'Ofertas', 'Blog'].map(l => (
                  <li key={l}><Link href="#" className="hover:text-white transition-all">{l}</Link></li>
                ))}
              </ul>
            </div>
            <div>
          ...
          <div className="max-w-7xl mx-auto mt-24 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-black text-white/40 uppercase tracking-widest">
            <p>© 2024 MYDOG DISTRIBUIDORA SPA. TODOS LOS DERECHOS RESERVADOS.</p>
            <div className="flex gap-8 opacity-50 grayscale">
              <div className="bg-white px-4 py-1.5 rounded-lg text-black">VISA</div>
              <div className="bg-white px-4 py-1.5 rounded-lg text-black">MASTERCARD</div>
            </div>
          </div>
        </div>
      </footer>

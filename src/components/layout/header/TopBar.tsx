      ...
      <div className="max-w-7xl mx-auto w-full flex justify-between items-center gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-4">
            <span className="select-none truncate hidden sm:block">
              {mounted 
            ...
            >
              ...
              <span>WhatsApp: +569 5788 9012</span>
            </a>
          </div>
        </div>
        ...
        {mounted && (
          <div className="flex items-center gap-4 sm:gap-5 shrink-0 animate-in fade-in duration-500">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="hover:opacity-70 hover:scale-110 transition-all flex items-center sm:hidden"
              title="WhatsApp"
            >

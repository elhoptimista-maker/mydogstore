 ...
 * Implementa un diseño responsivo adaptativo (Mobile-First) con capas optimizadas.
 */

export default function Hero() {
  return (
    <section className="relative w-full bg-[#FEF9F3] overflow-hidden border-b border-black/5">
      
      {/* 1. Capa de Decoración (Background) - Optimizada para no bloquear hilos */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[calc(100dvh-176px)] py-12 lg:py-0">
          
          {/* 3. Columna Visual (Aparece arriba en Mobile para impacto inmediato) */}
          <div className="relative w-full h-[320px] sm:h-[450px] lg:h-full flex items-end justify-center order-1 lg:order-2 animate-in fade-in zoom-in duration-1000">
            {/* Aura decorativa detrás de la mascota */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[80%] aspect-square bg-white/40 rounded-full border border-white/60 blur-md -z-10" />
            
            <div className="relative w-full h-full lg:h-[110%] lg:-mb-20">
              <Image
                src="https://picsum.photos/seed/happy-dog-hero/800/1000"
                alt="Mascota Feliz MyDog"
                fill
                className="object-contain drop-shadow-[0_25px_50px_rgba(0,0,0,0.15)] scale-105 lg:scale-115"
                priority

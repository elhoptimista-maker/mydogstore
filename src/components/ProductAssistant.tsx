    ...
    <div className="max-w-6xl mx-auto">
      <Card className="rounded-[3rem] border-none shadow-2xl overflow-hidden bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-5 min-h-[600px]">
          ...
          <div className="lg:col-span-2 bg-primary p-10 md:p-16 text-white flex flex-col justify-between">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-3xl md:text-4xl font-black leading-none tracking-tighter">Asistente <br /> Nutricional IA</h3>
                <p className="text-white/60 leading-relaxed font-medium text-sm md:text-base">
                  Nuestra inteligencia artificial analiza el perfil de tu mascota para recomendar productos basados en criterios técnicos veterinarios.
                </p>
              </div>
            </div>
            
            <div className="space-y-4 pt-10">
              {['Análisis Clínico', 'Optimización de Dieta', 'Prevención'].map((item) => (
          ...
          {/* Form & Results Area */}
          <div className="lg:col-span-3 p-10 md:p-16 flex flex-col justify-center bg-white">
            {!results ? (
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-2">
                  <h4 className="text-xl font-black text-primary tracking-tight">Personaliza la asesoría</h4>
                  <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Completa los datos de tu paciente</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    <Label htmlFor="breed" className="font-black text-primary/40 uppercase tracking-widest text-[9px]">Raza o Mezcla</Label>
                    <Input 
                      id="breed" 
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="age" className="font-black text-primary/40 uppercase tracking-widest text-[9px]">Etapa de Vida</Label>
                    <Input 
                      id="age" 
                ...
                <div className="space-y-3">
                  <Label htmlFor="needs" className="font-black text-primary/40 uppercase tracking-widest text-[9px]">Observaciones Médicas</Label>
                  <Input 
                    id="needs" 
                    placeholder="Ej: Sensibilidad estomacal o alergias" 
                    className="h-14 rounded-2xl border-primary/5 bg-muted/30 focus-visible:ring-primary/20 transition-all font-bold text-sm"
                ...
                >
                  {loading ? (
                    ...
                    <>
                      Generar Recomendación <ArrowRight className="ml-3 w-5 h-5" />
                    </>
                  )}
                </Button>
              </form>
                  ...
                  {results.recommendations.map((rec, i) => (
                    <div key={i} className="p-8 bg-muted/20 rounded-[2.5rem] border border-primary/5 group hover:bg-white hover:shadow-2xl transition-all duration-500">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <Badge className="bg-secondary/20 text-primary border-none text-[9px] font-black uppercase">Recomendado</Badge>
                      </div>
                      ...
                      <div className="p-5 bg-primary rounded-2xl text-white shadow-xl shadow-primary/10">
                        <p className="text-[11px] font-bold leading-relaxed italic opacity-90">
                          <span className="font-black uppercase not-italic mr-2 text-secondary">Justificación Técnica:</span>
